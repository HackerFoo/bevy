...
pub mod prelude {
    #[doc(hidden)]
    pub use crate::{
        AppLifecycle, CursorEntered, CursorIcon, CursorLeft, CursorMoved, FileDragAndDrop, MonitorSelection,
        OpenFile, ReceivedCharacter, Window, WindowDescriptor, WindowMode, WindowMoved, WindowPlugin,
